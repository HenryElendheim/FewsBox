...
object GameText {
    ...
    private val statusBlurbs = mapOf(
        ...
        "wind_shield" to "anyone who hits this unit catches the Wind",
        "wind" to "attacks have a 50% chance to miss entirely",
    ...
    private val offhandBlurbs = mapOf(
        ...
        "off_green_boon" to "A shield of moving air; swing into it and lose your aim.",
